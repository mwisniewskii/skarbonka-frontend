    ...
    await fetch("".concat(`${BaseUrl}`, ["users/"]), {
      ...
      .then((resJSON) => {
        ...
        resJSON
          ...
          .map((kid) => <li key={kid.id}>{children.push(`${kid.id}`)}</li>);
        setFirstId(children[0]);
      });
  }, []);
      ...
      <div className="mainStart">
        <div className="wrapp">
          <div className="panell">
            <p className="main-text">Przelew do dziecka</p>
            {firstId === undefined ? (
...
export default TransactionByParent;
